...
1. Launch the application by running the script.
  - Light version (old release)
    - ![sample](https://github.com/GeetaSystems/screenshot-utility/blob/main/sample-image.png?raw=true)
  - Dark version (new release)
    - ![sample](https://github.com/GeetaSystems/screenshot-utility/blob/main/ss-dark-mode.png?raw=true)
...
### Contributing
Contribution are welcome! Please open an issue or submit a pull request on [GitHub](https://github.com/GeetaSystems/screenshot-utility)
